...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO properties 
        (user_id, owner_agent_type, bhk_type, property_type, build_up_area, property_age, floor, total_floor, city, 
        available_for, expected_rent, expected_deposit, maintenance, available_from, preferred_tenants, furnishing, 
        ...
        '$floor', '$total_floor', '$city', '$available_for', '$expected_rent', '$expected_deposit', '$maintenance', 
