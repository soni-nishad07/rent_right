...
<body>
    ...
    $price_query = "SELECT DISTINCT expected_deposit_from, expected_deposit_to FROM category WHERE expected_deposit_from IS NOT NULL AND expected_deposit_to IS NOT NULL";
    ...
    ?>
            ...
            <div class="filters-btn2">
                <a href="buy_property2.php">More Filters</a>
            </div>
    ...
    <section class="locations-property">
        <div class="location-tags">
            <form action="" method="post" class="form-group location-form">
                ...
                <button type="button" class="btn" onclick="window.location.href='buy_search_property'">
    ...
    <script>
        ...
        function resetSearch() {
            ...
            window.location.href = 'buy_search_property'; // Reload property.php to reset search
        }
