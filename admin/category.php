...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['property_type'])) {
    ...
    $commercial_rent_from = isset($_POST['commercial_rent_from']) ? $_POST['commercial_rent_from'] : null;
    $commercial_rent_to = isset($_POST['commercial_rent_to']) ? $_POST['commercial_rent_to'] : null;
    ...
    $sql = "INSERT INTO category (property_choose, property_type, bhk_type, expected_rent_from, expected_rent_to, 
            expected_deposit_from, expected_deposit_to, commercial_rent_from, commercial_rent_to) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssssssss", $property_choose_str, $property_type, $bhk_type, 
        $expected_rent_from, $expected_rent_to, $expected_deposit_from, $expected_deposit_to, 
        $commercial_rent_from, $commercial_rent_to);
...
<body class="hold-transition sidebar-mini">
                            ...
                            <div class="panel-body">
                                <form class="col-sm-10" method="POST" action="">
                                    ...
                                    <div class="form-group" id="expected_deposit_fields" style="display: none;">
                                        <label for="expected_deposit_from">Expected Price From:</label>
                                        <input type="number" id="expected_deposit_from" name="expected_deposit_from" class="form-control" placeholder="Price From">
                                        <br>
                                        <label for="expected_deposit_to">Expected Price To:</label>
                                        <input type="number" id="expected_deposit_to" name="expected_deposit_to" class="form-control" placeholder="Price To">
                                    </div>
                                    ...
                                    <div class="form-group" id="commercial_rent_fields" style="display: none;">
                                        <label for="commercial_rent_from">Expected Commercial Rent From:</label>
                                        <input type="number" id="commercial_rent_from" name="commercial_rent_from" class="form-control" placeholder="Commercial Rent From">
                                        <br>
                                        <label for="commercial_rent_to">Expected Commercial Rent To:</label>
                                        <input type="number" id="commercial_rent_to" name="commercial_rent_to" class="form-control" placeholder="Commercial Rent To">
                                    </div>
    ...
    function toggleFields() {
        ...
        var commercialFields = document.getElementById("commercial_rent_fields");
