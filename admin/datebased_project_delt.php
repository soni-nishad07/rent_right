                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        if (mysqli_num_rows($res) > 0) {
                            ...
                            $propertyAge = intval($row['property_age']);
                            $expirationDate = clone $createdAt;
                            $expirationDate->modify("+$propertyAge years");

                            $currentDate = new DateTime();

                            // Check if the property is expired
                            if ($currentDate >= $expirationDate) {
                                // If expired, delete the property (add deletion logic here)
                                $deleteQuery = "DELETE FROM properties WHERE id = '$property_id'";
                                mysqli_query($conn, $deleteQuery);

                                echo "<script>alert('This property has been automatically deleted due to age.');</script>";
                                echo "<script>window.location.href = 'property_details';</script>";
                                exit; // Stop further processing
                            } else {
                                // Alert if the property is about to be deleted within 5 days
                                $daysUntilExpiration = $currentDate->diff($expirationDate)->days;
                                if ($daysUntilExpiration < 5) {
                                    echo "<script>alert('This property will be deleted in $daysUntilExpiration days.');</script>";
                                }
                            }
                        ?>
                                ...
                                <div class="table-responsive2">
                                    <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Area Sqft</th>
                                                <td><?php echo $row['build_up_area']; ?></td>
                                            </tr>
                                            <tr>
                                                <th>Property Age Type</th>
                                                <td><?php echo $row['property_age']; ?> year</td>
                                            </tr>
                                            <tr>
                                                <th>Floor</th>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['expected_deposit']; ?></td>
                                            </tr>
                                            <tr>
                                                <th>Maintenance</th>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['preferred_tenants']; ?></td>
                                            </tr>
                                            <tr>
                                                <th>Furnishing</th>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['available_all']; ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <button type="button" class="btn btn-danger" onclick="confirmDelete('<?php echo $row['id']; ?>')">Delete Property</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
    ...
    <script>
        function confirmDelete(propertyId) {
            if (confirm("Are you sure you want to delete this property? This action cannot be undone.")) {
                window.location.href = 'delete_property.php?id=' + propertyId; // Update with your deletion logic
            }
        }
    </script>
</body>
