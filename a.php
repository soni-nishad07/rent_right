                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="POST" action="">
                                                        ...
                                                        <select name="status" class="form-control" required  style="height:35px;border:0px; margin: 10px 0px;">
                                                ...
                                                <td>
    <span class="label <?php echo strtolower($row['approval_status']) === 'pending' ? 'label-warning' : ($row['approval_status'] === 'Approved' ? 'label-success' : 'label-danger'); ?>" style="border:0px">
...
<td>
    <form method="POST" action="">
        ...
        <select name="approval_status" class="form-control" required style="height:35px;border:0px; margin: 10px 0px;">
            <option value="" disabled>Select Approval Status</option>
            <option value="Approved" <?php echo ($row['approval_status'] == 'Approved') ? 'selected' : ''; ?>>Approve</option>
            <option value="Rejected" <?php echo ($row['approval_status'] == 'Rejected') ? 'selected' : ''; ?>>Reject</option>
        </select>
        <button type="submit" name="update_approval" class="btn btn-Info  mt-2">Update Approval</button>
    </form>
</td>
